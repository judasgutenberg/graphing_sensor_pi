...
<script>
	...
	displayViewOption( "statsCanvas", temperatures, barGraphInfo, "dummy");
	...
	function getWeatherData() { 
	    ...
	    xmlhttp.onreadystatechange = function() {
	        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				temperatures.push(JSON.parse(xmlhttp.responseText));
				//console.log(temperatures);
				displayViewOption( "statsCanvas", temperatures, barGraphInfo, "dummy");
	        }
		};
		let url = "backend.php?mode=getTemperature" ;
	  ...
	  <div style='display:inline-block;width:500px;height:400px'> <canvas id="statsCanvas" style='display:block;'></canvas></div>
      <div class="container-fluid text-center liveimage" style='display:inline-block;width:500px'>
